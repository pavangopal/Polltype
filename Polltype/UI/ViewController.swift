...
class ViewController: UIViewController {
    ...
    func doRegistrations(){
        ...
        self.sizingCell["PolltypeCell"] = nib1.instantiate(withOwner: self, options: nil)[0] as! PolltypeCell
...
extension ViewController:UICollectionViewDelegateFlowLayout{
    ...
    internal func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if let poll = polls[models[indexPath.item]]{
            ...
            let sizingCell = self.sizingCell["PolltypeCell"] as! PolltypeCell
        ...
        api.vote(poll,storyURL: nil,opinionIndex: opinionIndex) { (polld, error) in
            ...
            if let index = someIndex{
                ...
                for value in Array(self.pollIndexPathMapping.values){
                        ...
                        if let cell = self.collection_view.cellForItem(at: value) as? PolltypeCell{
