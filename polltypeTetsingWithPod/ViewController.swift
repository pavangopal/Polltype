...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        Polltype.shared.configure(withHostUrl: "https://polltype-api.staging.quintype.io",imageCDN:"qt-staging-01.imgix.net",storyUrl: "https://thequint.staging.quintype.io/news/2017/04/10/polltype-for-different-langs")
        
        Polltype.shared.parentViewController = self
